...
export default {
    ...
    sections: {
        ...
        "Collection": {
            url: "api/v1.0/post-groups/{{PAYLOAD_KEY}}"
        },
        "Person": {
            url: "/api/v1.0/casts/{{PAYLOAD_KEY}}"
        },
        "SearchDependency": {
            url: "api/v1.0/search-dependency/category",
        },
        "SearchAdvanced": {
            url: "api/v1.0/search/advance",
            page: 1,
            count: 20,
            type: 'all',
            dubs: undefined,
            ...
            language: undefined,
            query: undefined,
            CountryProducer: undefined,
            subcategories: undefined,
            searchOrderType: undefined,
            ADProductionYear: undefined,
            PersianProductionYear: undefined,
